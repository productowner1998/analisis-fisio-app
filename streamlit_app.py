...
# Este método es más seguro ya que no expones el JSON en tu repositorio público.
# 1. En Streamlit Cloud, ve a "Settings" > "Secrets".
# 2. Pega el contenido completo de tu archivo JSON allí.
try:
...
if data_loaded_successfully:
    ...
    if search_id:
        ...
        if not patient_records.empty:
            patient_name = patient_records['Nombre Paciente'].iloc[0]
...
* **Muy importante:** En la línea `SPREADSHEET_NAME = "..."`, reemplaza el texto con el nombre **exacto** de tu archivo de Google Sheets.
