        ...
        if match:
            ...
            if st.button("Analizar Progreso", disabled=not (fecha_comparativa and fecha_evolutiva)):
                if fecha_comparativa == fecha_evolutiva:
                    ...
                    # CSS para el estilo de la tabla
                    html_style = """
                    <style>
                        .results-table {
                            width: 100%;
                    ...
                    <table class="results-table">
                        <thead>
                            <tr>
                                ...
                                <th style="width:15%;">Diferencia (Evolutiva - Comparativa)</th>
                                <th>Análisis</th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    for col in columnas_analisis:
                        ...
                        # Definir la clase de color para la diferencia
                        diff_class = ""
                    ...
                    # Renderizar la tabla HTML en la aplicación
